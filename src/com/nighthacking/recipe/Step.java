...
public class Step {
  ...
  public static Step waitForTemp(double temp) {
    return waitForTemp(temp, 5);
  }

  public static Step waitForTemp(double temp, double margin) {
    return new Step(e -> e.getTemperatureSensor().waitFor(w -> Math.abs(w - temp) < margin));
  }
